...
public class LeftBound {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(test.leftBound(nums, 5));
        System.out.println(test.leftBound2(nums, 5));
        System.out.println(test.leftBound3(nums, 4));
    }
     ...
     * @param nums
     * @param target
     * @return [0, nums.length]，可以理解为小于target的元素数量
     */
